...
import static com.xxmicloxx.NoteBlockAPI.model.Sound.getFromBukkitName;
...
public class InstrumentUtils {
    ...
    public static org.bukkit.Sound getInstrument(byte instrument) {
        return getFromBukkitName(getInstrumentName(instrument));
    }
    ...
    public static String getInstrumentName(byte instrument) {
        switch (instrument) {
            case 1:
                return getFromBukkitName("BLOCK_NOTE_BLOCK_BASS").name();
            case 2:
                return getFromBukkitName("BLOCK_NOTE_BLOCK_BASEDRUM").name();
            case 3:
                return getFromBukkitName("BLOCK_NOTE_BLOCK_SNARE").name();
            case 4:
                return getFromBukkitName("BLOCK_NOTE_BLOCK_HAT").name();
            case 5:
                return getFromBukkitName("BLOCK_NOTE_BLOCK_GUITAR").name();
            case 6:
                return getFromBukkitName("BLOCK_NOTE_BLOCK_FLUTE").name();
            case 7:
                return getFromBukkitName("BLOCK_NOTE_BLOCK_BELL").name();
            case 8:
                return getFromBukkitName("BLOCK_NOTE_BLOCK_CHIME").name();
            case 9:
                return getFromBukkitName("BLOCK_NOTE_BLOCK_XYLOPHONE").name();
            case 10:
                return getFromBukkitName("BLOCK_NOTE_BLOCK_IRON_XYLOPHONE").name();
            case 11:
                return getFromBukkitName("BLOCK_NOTE_BLOCK_COW_BELL").name();
            case 12:
                return getFromBukkitName("BLOCK_NOTE_BLOCK_DIDGERIDOO").name();
            case 13:
                return getFromBukkitName("BLOCK_NOTE_BLOCK_BIT").name();
            case 14:
                return getFromBukkitName("BLOCK_NOTE_BLOCK_BANJO").name();
            case 15:
                return getFromBukkitName("BLOCK_NOTE_BLOCK_PLING").name();
            default:
                return getFromBukkitName("BLOCK_NOTE_BLOCK_HARP").name();
        }
    }
    ...
    public static Instrument getBukkitInstrument(byte instrument) {
        switch (instrument) {
            ...
            default: {
                if (CompatibilityUtils.getServerVersion() >= 0.0112f) switch (instrument) {
                    case 5:
                    ...
                    default: {
                        if (CompatibilityUtils.getServerVersion() >= 0.0114f) switch (instrument) {
                            case 10:
    ...
    public static byte getCustomInstrumentFirstIndex() {
        if (CompatibilityUtils.getServerVersion() >= 0.0114f) return 16;
        if (CompatibilityUtils.getServerVersion() >= 0.0112f) return 10;
        return 5;
    }
}