...
public class ExtraGear extends SfAddon {
    ...
    @Override
    public void Load() {
        itemGroup = new ItemGroup(UNUtilities.createKey("items"), new CustomItemStack(Material.DIAMOND_SWORD, "&6ExtraGear"), 1);
    ...
    private void registerSword(Material type, String component, ItemStack item, List<Pair<Enchantment, Integer>> enchantments) {
        ...
        researchId++;
        Research research = new Research(UNUtilities.createKey(component.toLowerCase() + "_sword"), researchId, ChatUtils.humanize(component) + " Sword", 3);
    ...
    private void registerArmor(ArmorSet armorset, String component, ItemStack item, List<Pair<Enchantment, Integer>> enchantments) {
        ...
        boots.register(this);
        researchId++;
        Research research = new Research(UNUtilities.createKey(component.toLowerCase() + "_armor"), researchId, humanizedComponent + " Armor", 5);
