...
public class PublicChests {
    public PublicChests(PrivateStorage addon, ItemGroup itemGroup) {
        ...
        new SlimefunChest(ChestProtectionLevel.PUBLIC, 45, false, itemGroup, chestSteel, RecipeType.ENHANCED_CRAFTING_TABLE,
                ...
                .register(addon);
        new Research(UNUtilities.createKey("wooden_chests"), 606, "Top Tier Storage", 20).addItems(chestOak, chestBirch, chestSpruce, chestJungle, chestAcacia, chestDarkOak).register();
        new Research(UNUtilities.createKey("metal_chests"), 608, "Improved Storage", 16).addItems(chestIron, chestGold, chestDiamond, chestEmerald).register();
        new Research(UNUtilities.createKey("hardened_chests"), 607, "Hardened Storage", 24).addItems(chestObsidian, chestSteel).register();
    }
