...
public final class SMGItems {
    public static final ItemGroup SMG_ITEM_CATEGORY = new ItemGroup(UNUtilities.createKey("simplematerialgenerators"), new CustomItemStack(Material.SMOOTH_STONE, "&9Simple Material Generators"));
    ...
    public static final SlimefunItemStack SMG_GENERATOR_REDSTONE_BADLY_FORMED = new SlimefunItemStack("SMG_GENERATOR_REDSTONE_BADLY_FORMED", Material.REDSTONE_BLOCK, "&cRedstone generator &8(Badly Formed)", "&8Needs to be reformed", "", "&9&oSimpleMaterialGenerators");
    public static final SlimefunItemStack SMG_GENERATOR_REDSTONE_BROKEN = new SlimefunItemStack("SMG_GENERATOR_REDSTONE_BROKEN", Material.REDSTONE_BLOCK, "&cRedstone generator &8(Broken)", "&8Needs to be repaired", "", "&9&oSimpleMaterialGenerators");
    public static final SlimefunItemStack SMG_GENERATOR_REDSTONE = new SlimefunItemStack("SMG_GENERATOR_REDSTONE", Material.REDSTONE_BLOCK, "&cRedstone generator", "&6Rate: &e24 ticks", "", "&9&oSimpleMaterialGenerators");
    public static final SlimefunItemStack SMG_GENERATOR_OBSIDIAN_BADLY_FORMED = new SlimefunItemStack("SMG_GENERATOR_OBSIDIAN_BADLY_FORMED", Material.OBSIDIAN, "&5Obsidian generator &8(Badly Formed)", "&8Needs to be reformed", "", "&9&oSimpleMaterialGenerators");
    public static final SlimefunItemStack SMG_GENERATOR_OBSIDIAN_BROKEN = new SlimefunItemStack("SMG_GENERATOR_OBSIDIAN_BROKEN", Material.OBSIDIAN, "&5Obsidian generator &8(Broken)", "&8Needs to be repaired", "", "&9&oSimpleMaterialGenerators");
    public static final SlimefunItemStack SMG_GENERATOR_OBSIDIAN = new SlimefunItemStack("SMG_GENERATOR_OBSIDIAN", Material.OBSIDIAN, "&5Obsidian generator", "&6Rate: &e128 ticks", "", "&9&oSimpleMaterialGenerators");
}