...
public class PacketReceiveEvent extends PacketEvent {
    ...
    public PacketReceiveEvent(final ChannelHandlerContext channelHandlerContext, final HamsterPlayer hamsterPlayer, final PacketWrapper packet, final boolean async) {
