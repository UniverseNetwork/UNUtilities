...
public class PacketDecodeEvent extends PacketEvent {
    ...
    public PacketDecodeEvent(final ChannelHandlerContext channelHandlerContext, final HamsterPlayer hamsterPlayer, final ByteBufWrapper byteBuf, final boolean async) {
