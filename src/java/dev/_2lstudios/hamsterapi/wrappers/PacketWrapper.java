...
public class PacketWrapper {
    ...
    public PacketWrapper(final Object packet) {
        ...
        for (final Field field : packetClass.getDeclaredFields()) {
            try {
                ...
                if (value instanceof String) this.strings.put(fieldName, (String) value);
                else if (value instanceof Integer) this.integers.put(fieldName, (Integer) value);
                else if (value instanceof Float) this.floats.put(fieldName, (Float) value);
                else if (value instanceof Double) this.doubles.put(fieldName, (Double) value);
                else if (value instanceof Boolean) this.booleans.put(fieldName, (Boolean) value);
                ...
                } else this.objects.put(fieldName, value);
    ...
    public PacketType getType() {
        for (final PacketType packetType : PacketType.values())
            if (packetType.name().equals(this.name)) return packetType;
        return null;
    }
