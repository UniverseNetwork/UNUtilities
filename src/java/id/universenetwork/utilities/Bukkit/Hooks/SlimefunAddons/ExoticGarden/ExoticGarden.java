...
import id.universenetwork.utilities.Bukkit.Hooks.SlimefunAddons.ExoticGarden.Items.*;
import id.universenetwork.utilities.Bukkit.Hooks.SlimefunAddons.ExoticGarden.Listeners.AndroidListener;
import id.universenetwork.utilities.Bukkit.Hooks.SlimefunAddons.ExoticGarden.Listeners.PlantsListener;
...
public class ExoticGarden {
    public static ExoticGarden instance;
    final File schematicsFolder = new File("plugins/Slimefun/schematics");
    final List<Berry> berries = new ArrayList<>();
    final List<Tree> trees = new ArrayList<>();
    final Map<String, ItemStack> items = new HashMap<>();
    final Set<String> treeFruits = new HashSet<>();
    protected ConfigurationSection cfg;
    NestedItemGroup nestedItemGroup;
    ItemGroup mainItemGroup;
    ItemGroup miscItemGroup;
    ItemGroup foodItemGroup;
    ItemGroup drinksItemGroup;
    ItemGroup magicalItemGroup;
    Kitchen kitchen;

    public ExoticGarden() {
        if (Enabled("ExoticGarden")) {
            PaperLib.suggestPaper(addon.getJavaPlugin());
            if (!schematicsFolder.exists()) schematicsFolder.mkdirs();
            instance = this;
            cfg = Settings("ExoticGarden");
            nestedItemGroup = new NestedItemGroup(new NamespacedKey(UNUtilities.plugin, "parent_category"), new CustomItemStack(getItemStack(fromHashCode("847d73a91b52393f2c27e453fb89ab3d784054d414e390d58abd22512edd2b")), "&aExotic Garden"));
            mainItemGroup = new SubItemGroup(new NamespacedKey(UNUtilities.plugin, "plants_and_fruits"), nestedItemGroup, new CustomItemStack(getItemStack(fromHashCode("a5a5c4a0a16dabc9b1ec72fc83e23ac15d0197de61b138babca7c8a29c820")), "&aExotic Garden - Plants and Fruits"));
            miscItemGroup = new SubItemGroup(new NamespacedKey(UNUtilities.plugin, "misc"), nestedItemGroup, new CustomItemStack(getItemStack(fromHashCode("606be2df2122344bda479feece365ee0e9d5da276afa0e8ce8d848f373dd131")), "&aExotic Garden - Ingredients and Tools"));
            foodItemGroup = new SubItemGroup(new NamespacedKey(UNUtilities.plugin, "food"), nestedItemGroup, new CustomItemStack(getItemStack(fromHashCode("a14216d10714082bbe3f412423e6b19232352f4d64f9aca3913cb46318d3ed")), "&aExotic Garden - Food"));
            drinksItemGroup = new SubItemGroup(new NamespacedKey(UNUtilities.plugin, "drinks"), nestedItemGroup, new CustomItemStack(getItemStack(fromHashCode("2a8f1f70e85825607d28edce1a2ad4506e732b4a5345a5ea6e807c4b313e88")), "&aExotic Garden - Drinks"));
            magicalItemGroup = new SubItemGroup(new NamespacedKey(UNUtilities.plugin, "magical_crops"), nestedItemGroup, new CustomItemStack(Material.BLAZE_POWDER, "&5Exotic Garden - Magical Plants"));
            kitchen = new Kitchen(miscItemGroup);
            kitchen.register(addon);
            Research kitchenResearch = new Research(new NamespacedKey(UNUtilities.plugin, "kitchen"), 600, "Kitchen", 30);
            ...
            new SlimefunItem(miscItemGroup, iceCube, RecipeType.GRIND_STONE, new ItemStack[]{new ItemStack(Material.ICE), null, null, null, null, null, null, null, null}, new SlimefunItemStack(iceCube, 4)).register(addon);
            ...
            registerMagicalPlant("Gold", GOLD_4K, "e4df892293a9236f73f48f9efe979fe07dbd91f7b5d239e4acfd394f6eca", new ItemStack[]{null, GOLD_16K, null, GOLD_16K, getItem("IRON_PLANT"), GOLD_16K, null, GOLD_16K, null});
            registerMagicalPlant("Copper", new CustomItemStack(COPPER_DUST, 8), "d4fc72f3d5ee66279a45ac9c63ac98969306227c3f4862e9c7c2a4583c097b8a", new ItemStack[]{null, COPPER_DUST, null, COPPER_DUST, getItem("GOLD_PLANT"), COPPER_DUST, null, COPPER_DUST, null});
            registerMagicalPlant("Aluminum", new CustomItemStack(ALUMINUM_DUST, 8), "f4455341eaff3cf8fe6e46bdfed8f501b461fb6f6d2fe536be7d2bd90d2088aa", new ItemStack[]{null, ALUMINUM_DUST, null, ALUMINUM_DUST, getItem("IRON_PLANT"), ALUMINUM_DUST, null, ALUMINUM_DUST, null});
            registerMagicalPlant("Tin", new CustomItemStack(TIN_DUST, 8), "6efb43ba2fe6959180ee7307f3f054715a34c0a07079ab73712547ffd753dedd", new ItemStack[]{null, TIN_DUST, null, TIN_DUST, getItem("IRON_PLANT"), TIN_DUST, null, TIN_DUST, null});
            registerMagicalPlant("Silver", new CustomItemStack(SILVER_DUST, 8), "1dd968b1851aa7160d1cd9db7516a8e1bf7b7405e5245c5338aa895fe585f26c", new ItemStack[]{null, SILVER_DUST, null, SILVER_DUST, getItem("IRON_PLANT"), SILVER_DUST, null, SILVER_DUST, null});
            registerMagicalPlant("Lead", new CustomItemStack(LEAD_DUST, 8), "93c3c418039c4b28b0da75a6d9b22712c7015432d4f4226d6cc0a77d54b64178", new ItemStack[]{null, LEAD_DUST, null, LEAD_DUST, getItem("IRON_PLANT"), LEAD_DUST, null, LEAD_DUST, null});
            ...
            new GrassSeeds(mainItemGroup, grassSeeds, ExoticGardenRecipeTypes.BREAKING_GRASS, new ItemStack[]{null, null, null, null, new ItemStack(Material.GRASS), null, null, null, null}).register(addon);
            // @formatter:on
            ...
            while (iterator.hasNext()) {
                ...
                if (!cfg.contains("grass-drops." + key)) cfg.set("grass-drops." + key, true);
    ...
    @Nullable
    static ItemStack getItem(@NotNull String id) {
        SlimefunItem item = SlimefunItem.getById(id);
        return item != null ? item.getItem() : null;
    }

    @Nullable
    public static ItemStack harvestPlant(@NotNull Block block) {
    ...
    void saveSchematic(@NotNull String id) {
        try (InputStream input = getClass().getResourceAsStream("/schematics/" + id + ".schematic")) {
            ...
            Bukkit.getLogger().log(java.util.logging.Level.SEVERE, e, () -> "Failed to load file: \"" + id + ".schematic\"");
        }
    }

    void registerTree(String name, String texture, String color, Color pcolor, String juice, boolean pie, Material... soil) {
        ...
        new BonemealableItem(mainItemGroup, sapling, ExoticGardenRecipeTypes.BREAKING_GRASS, new ItemStack[]{null, null, null, null, new ItemStack(Material.GRASS), null, null, null, null}).register(addon);
        new ExoticGardenFruit(mainItemGroup, new SlimefunItemStack(id, texture, color + name), ExoticGardenRecipeTypes.HARVEST_TREE, true, new ItemStack[]{null, null, null, null, getItem(id + "_SAPLING"), null, null, null, null}).register(addon);
        if (pcolor != null)
            new Juice(drinksItemGroup, new SlimefunItemStack(juice.toUpperCase().replace(" ", "_"), new CustomPotion(color + juice, pcolor, new PotionEffect(PotionEffectType.SATURATION, 6, 0), "", "&7&oRestores &b&o" + "3.0" + " &7&oHunger")), RecipeType.JUICER, new ItemStack[]{getItem(id), null, null, null, null, null, null, null, null}).register(addon);
        if (pie)
            new CustomFood(foodItemGroup, new SlimefunItemStack(id + "_PIE", "3418c6b0a29fc1fe791c89774d828ff63d2a9fa6c83373ef3aa47bf3eb79", color + name + " Pie", "", "&7&oRestores &b&o" + "6.5" + " &7&oHunger"), new ItemStack[]{getItem(id), new ItemStack(Material.EGG), new ItemStack(Material.SUGAR), new ItemStack(Material.MILK_BUCKET), WHEAT_FLOUR, null, null, null, null}, 13).register(addon);
    ...
    public void registerBerry(String name, ChatColor color, Color potionColor, PlantType type, String texture) {
        ...
        new BonemealableItem(mainItemGroup, sfi, ExoticGardenRecipeTypes.BREAKING_GRASS, new ItemStack[]{null, null, null, null, new ItemStack(Material.GRASS), null, null, null, null}).register(addon);
        new ExoticGardenFruit(mainItemGroup, new SlimefunItemStack(upperCase, texture, color + name), ExoticGardenRecipeTypes.HARVEST_BUSH, true, new ItemStack[]{null, null, null, null, getItem(upperCase + "_BUSH"), null, null, null, null}).register(addon);
        new Juice(drinksItemGroup, new SlimefunItemStack(upperCase + "_JUICE", new CustomPotion(color + name + " Juice", potionColor, new PotionEffect(PotionEffectType.SATURATION, 6, 0), "", "&7&oRestores &b&o" + "3.0" + " &7&oHunger")), RecipeType.JUICER, new ItemStack[]{getItem(upperCase), null, null, null, null, null, null, null, null}).register(addon);
        ...
        new CustomFood(foodItemGroup, new SlimefunItemStack(upperCase + "_JELLY_SANDWICH", "8c8a939093ab1cde6677faf7481f311e5f17f63d58825f0e0c174631fb0439", color + name + " Jelly Sandwich", "", "&7&oRestores &b&o" + "8.0" + " &7&oHunger"), new ItemStack[]{null, new ItemStack(Material.BREAD), null, null, getItem(upperCase + "_JUICE"), null, null, new ItemStack(Material.BREAD), null}, 16).register(addon);
        new CustomFood(foodItemGroup, new SlimefunItemStack(upperCase + "_PIE", "3418c6b0a29fc1fe791c89774d828ff63d2a9fa6c83373ef3aa47bf3eb79", color + name + " Pie", "", "&7&oRestores &b&o" + "6.5" + " &7&oHunger"), new ItemStack[]{getItem(upperCase), new ItemStack(Material.EGG), new ItemStack(Material.SUGAR), new ItemStack(Material.MILK_BUCKET), WHEAT_FLOUR, null, null, null, null}, 13).register(addon);
    }
    ...
    public void registerPlant(String name, ChatColor color, PlantType type, String texture) {
        ...
        new BonemealableItem(mainItemGroup, bush, ExoticGardenRecipeTypes.BREAKING_GRASS, new ItemStack[]{null, null, null, null, new ItemStack(Material.GRASS), null, null, null, null}).register(addon);
        new ExoticGardenFruit(mainItemGroup, new SlimefunItemStack(enumStyle, texture, color + name), ExoticGardenRecipeTypes.HARVEST_BUSH, true, new ItemStack[]{null, null, null, null, getItem(enumStyle + "_BUSH"), null, null, null, null}).register(addon);
    }

    void registerMagicalPlant(String name, ItemStack item, String texture, ItemStack[] recipe) {
        String upperCase = name.toUpperCase(Locale.ROOT);
        String enumStyle = upperCase.replace(' ', '_');
        ...
        berries.add(berry);
        new BonemealableItem(magicalItemGroup, new SlimefunItemStack(enumStyle + "_PLANT", Material.OAK_SAPLING, "&r" + name + " Plant"), RecipeType.ENHANCED_CRAFTING_TABLE, recipe).register(addon);
        MagicalEssence magicalEssence = new MagicalEssence(magicalItemGroup, essence);
        magicalEssence.setRecipeOutput(item.clone());
        magicalEssence.register(addon);
    }
