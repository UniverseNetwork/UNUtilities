...
public class ExtraGear {
    ...
    public ExtraGear() {
        if (id.universenetwork.utilities.Bukkit.Hooks.SlimefunAddons.Addons.Enabled("ExtraGear")) {
            itemGroup = new ItemGroup(new NamespacedKey(plugin, "items"), new io.github.thebusybiscuit.slimefun4.libraries.dough.items.CustomItemStack(Material.DIAMOND_SWORD, "&6ExtraGear"), 1);
            registerSword(Material.IRON_SWORD, "COPPER", COPPER_INGOT, singletonList(new Pair<>(Enchantment.DAMAGE_UNDEAD, 2)));
            registerArmor(ArmorSet.LEATHER, "COPPER", COPPER_INGOT, singletonList(new Pair<>(Enchantment.PROTECTION_EXPLOSIONS, 2)));
            registerSword(Material.IRON_SWORD, "TIN", TIN_INGOT, singletonList(new Pair<>(Enchantment.DAMAGE_ALL, 1)));
            registerArmor(ArmorSet.IRON, "TIN", TIN_INGOT, singletonList(new Pair<>(Enchantment.PROTECTION_EXPLOSIONS, 3)));
            registerSword(Material.IRON_SWORD, "SILVER", SILVER_INGOT, singletonList(new Pair<>(Enchantment.DAMAGE_ALL, 2)));
            registerArmor(ArmorSet.IRON, "SILVER", SILVER_INGOT, singletonList(new Pair<>(Enchantment.PROTECTION_ENVIRONMENTAL, 2)));
            registerSword(Material.IRON_SWORD, "ALUMINUM", ALUMINUM_INGOT, singletonList(new Pair<>(Enchantment.DAMAGE_ARTHROPODS, 3)));
            ...
            registerSword(Material.IRON_SWORD, "ZINC", ZINC_INGOT, singletonList(new Pair<>(Enchantment.DAMAGE_ALL, 2)));
            registerArmor(ArmorSet.IRON, "ZINC", ZINC_INGOT, singletonList(new Pair<>(Enchantment.PROTECTION_ENVIRONMENTAL, 3)));
