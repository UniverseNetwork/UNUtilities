...
public class DynaTechItems {
    ...
    // Machines
    public static final SlimefunItemStack AUTO_KITCHEN = new SlimefunItemStack("AUTO_KITCHEN", SMOKER, "&6Auto Kitchen", "", "&fAutomatically makes Kitchen recipes", "", "&f&oSmells like cookies", "", machine(MachineTier.MEDIUM, MACHINE), speed(1), LoreBuilderDynamic.powerPerSecond(16));
    public static final SlimefunItemStack GROWTH_CHAMBER = new SlimefunItemStack("GROWTH_CHAMBER", GREEN_STAINED_GLASS, "&6Growth Chamber", "", "&fAutomatically grows &eplants&f.", "", "&f&oIts like a small greenhouse!", "", machine(MachineTier.MEDIUM, MACHINE), speed(1), LoreBuilderDynamic.powerPerSecond(32));
    public static final SlimefunItemStack GROWTH_CHAMBER_MK2 = new SlimefunItemStack("GROWTH_CHAMBER_MK2", LIME_STAINED_GLASS, "&6Growth Chamber MK2", "", "&fAutomatically grows &eplants&f.", "", "&f&oIts like a small greenhouse!", "", "&c3x production.", machine(MachineTier.MEDIUM, MACHINE), speed(3), LoreBuilderDynamic.powerPerSecond(128));
    public static final SlimefunItemStack GROWTH_CHAMBER_END = new SlimefunItemStack("GROWTH_CHAMBER_END", MAGENTA_STAINED_GLASS, "&dEnd Growth Chamber", "", "&fAutomatically grows &dchorus flowers.", "", machine(MachineTier.MEDIUM, MACHINE), speed(1), LoreBuilderDynamic.powerPerSecond(32));
    public static final SlimefunItemStack GROWTH_CHAMBER_END_MK2 = new SlimefunItemStack("GROWTH_CHAMBER_END_MK2", PURPLE_STAINED_GLASS, "&dEnd Growth Chamber MK2", "", "&fAutomatically grows &dchorus flowers.", "", "&c3x production.", machine(MachineTier.MEDIUM, MACHINE), speed(3), LoreBuilderDynamic.powerPerSecond(128));
    public static final SlimefunItemStack GROWTH_CHAMBER_NETHER = new SlimefunItemStack("GROWTH_CHAMBER_NETHER", RED_STAINED_GLASS, "&cNether Growth Chamber", "", "&fAutomatically grows &cnether &fplants.", "", machine(MachineTier.MEDIUM, MACHINE), speed(1), LoreBuilderDynamic.powerPerSecond(32));
    public static final SlimefunItemStack GROWTH_CHAMBER_NETHER_MK2 = new SlimefunItemStack("GROWTH_CHAMBER_NETHER_MK2", RED_STAINED_GLASS, "&cNether Growth Chamber MK2", "", "&fAutomatically grows &cnether &fplants.", "", "&c3x production.", machine(MachineTier.MEDIUM, MACHINE), speed(3), LoreBuilderDynamic.powerPerSecond(128));
    public static final SlimefunItemStack GROWTH_CHAMBER_OCEAN = new SlimefunItemStack("GROWTH_CHAMBER_OCEAN", CYAN_STAINED_GLASS, "&bOcean Growth Chamber", "", "&fAutomatically grows &9water &fplants.", "Can revive dead coral!", "", machine(MachineTier.MEDIUM, MACHINE), speed(1), LoreBuilderDynamic.powerPerSecond(32));
    public static final SlimefunItemStack GROWTH_CHAMBER_OCEAN_MK2 = new SlimefunItemStack("GROWTH_CHAMBER_OCEAN_MK2", LIGHT_BLUE_STAINED_GLASS, "&bOcean Growth Chamber MK2", "", "&fAutomatically grows &9water &fplants.", "Can revive dead coral!", "", "&c3x production.", machine(MachineTier.MEDIUM, MACHINE), speed(3), LoreBuilderDynamic.powerPerSecond(128));
    public static final SlimefunItemStack ANTIGRAVITY_BUBBLE = new SlimefunItemStack("ANTIGRAVITY_BUBBLE", OBSIDIAN, "&6Antigravity Bubble", "", "&f Creative Flight within an 45 block area", "", machine(MachineTier.END_GAME, MACHINE), LoreBuilderDynamic.powerPerSecond(128));
    public static final SlimefunItemStack WEATHER_CONTROLLER = new SlimefunItemStack("WEATHER_CONTROLLER", BLUE_STAINED_GLASS, "&6Weather Controller", "", "&fControls the weather when given a key item.", "", machine(MachineTier.MEDIUM, MACHINE), LoreBuilderDynamic.powerPerSecond(32));
    public static final SlimefunItemStack POTION_SPRINKLER = new SlimefunItemStack("POTION_SPRINKLER", new CustomItemStack(getItemStack(fromHashCode("8d302104180cb79d5f4cf423649ddfa8ffb31a1875fa02a983cd248c72dfb0ea"))), "&6Potion Sprinkler", "", "&fRanged Multiple person potion effect applier.", "", machine(MachineTier.MEDIUM, MACHINE), LoreBuilderDynamic.powerPerSecond(32));
    public static final SlimefunItemStack BARBED_WIRE = new SlimefunItemStack("BARBED_WIRE", new CustomItemStack(getItemStack(fromHashCode("b2ac6c219004d82dfa627ffab664f29c53ecc112d91c9d7a9c915c426832412"))), "&6Barbed Wire", "", "&fPushes mobs away in a radius.", "", machine(MachineTier.MEDIUM, MACHINE), LoreBuilderDynamic.powerPerSecond(16));
    public static final SlimefunItemStack MATERIAL_HIVE = new SlimefunItemStack("MATERIAL_HIVE", BEEHIVE, "&6Material Hive", "", "&fUsing power and bees, slowly generates materials.", "", radioactive(io.github.thebusybiscuit.slimefun4.core.attributes.Radioactivity.HIGH), "", machine(MachineTier.END_GAME, MACHINE), LoreBuilderDynamic.powerPerSecond(1024));
    public static final SlimefunItemStack WIRELESS_CHARGER = new SlimefunItemStack("WIRELESS_CHARGER", CLAY, "&6Wireless Charger", "", "&fWireless charge items in your inventory", "", machine(MachineTier.MEDIUM, MACHINE), LoreBuilderDynamic.powerPerSecond(16));
    public static final SlimefunItemStack SEED_PLUCKER = new SlimefunItemStack("SEED_PLUCKER", ORANGE_STAINED_GLASS, "&6Seed Plucker", "", "&fPull seeds out of plant based items.", "", machine(MachineTier.MEDIUM, MACHINE), LoreBuilderDynamic.powerPerSecond(32));
    public static final SlimefunItemStack BANDAID_MANAGER = new SlimefunItemStack("BANDAID_MANAGER", LAPIS_BLOCK, "&6Item Band Manager", "", "&fManages Item Bands", "", machine(MachineTier.ADVANCED, MACHINE), LoreBuilderDynamic.powerPerSecond(48));
    public static final SlimefunItemStack ORECHID = new SlimefunItemStack("ORECHID", END_ROD, "&6Orechid", "", "&fUsing Stone or Netherack and power, it makes their respective ores.", "", machine(MachineTier.END_GAME, MACHINE), LoreBuilderDynamic.power(1024, " per block converted."));
    public static final SlimefunItemStack WIRELESS_ENERGY_POINT = new SlimefunItemStack("WIRELESS_ENERGY_POINT", new CustomItemStack(getItemStack(fromHashCode("335a21d95e8597759fb259c951ea68e1ad3374ca41e56ef126ffabfe03c1e0"))), "&6Wireless Energy Point", "", "&fTransfers Energy Wirelessly", "&ffrom a Wireless Energy Bank", "Right Click on the Wireless Energy Bank to connect!", "", machine(MachineTier.MEDIUM, MACHINE), powerBuffer(5120), LoreBuilderDynamic.powerPerSecond(1024), "");
    public static final SlimefunItemStack WIRELESS_ENERGY_BANK = new SlimefunItemStack("WIRELESS_ENERGY_BANK", SNOW_BLOCK, "&6Wireless Energy Bank", "", "&fStores power for an", "&fWireless Energy Point to use.", "", machine(MachineTier.MEDIUM, CAPACITOR), powerBuffer(10240), LoreBuilderDynamic.powerPerSecond(1024), "");
    public static final SlimefunItemStack WIRELESS_ITEM_INPUT = new SlimefunItemStack("WIRELESS_ITEM_INPUT", new CustomItemStack(getItemStack(fromHashCode("abb55560c695d976b346e188d3df2bcd8c5aa32b933141a9715c42f64cb6cee"))), "&6Wireless Item Input", "", "&fTransfers Items Wirelessly", "&f to Wireless Item Output", "", machine(MachineTier.MEDIUM, MACHINE), powerBuffer(1024), LoreBuilderDynamic.power(8, " per stack of items"), "");
    public static final SlimefunItemStack WIRELESS_ITEM_OUTPUT = new SlimefunItemStack("WIRELESS_ITEM_OUTPUT", new CustomItemStack(getItemStack(fromHashCode("c510d9b61ca333d2946c61a26cb17e374d4adb573b46afdebaf89f65ba5d4ae2"))), "&6Wireless Item Output", "", "&fTransfer Items Wirelessly", "&ffrom Wireless Item Input", "Right Click on the Wireless Item Output to connect!", "", machine(MachineTier.MEDIUM, MACHINE), powerBuffer(1024), LoreBuilderDynamic.power(8, " per stack of items"), "");
    public static final SlimefunItemStack TESSERACT = new SlimefunItemStack("TESSERACT", PURPUR_BLOCK, "&6Tesseract", "", "&fTransfers Items and Energy Wirelessly", "&fThese are even 2-way!", "Right Click on another Tesseract to connect!", "", machine(MachineTier.END_GAME, MACHINE), powerBuffer(65535), LoreBuilderDynamic.powerPerSecond(1024), "");

    // Generators
    public static final SlimefunItemStack WATER_MILL = new SlimefunItemStack("WATER_MILL", COBBLESTONE_WALL, "&6Hydro Generator", "", "&fCreates energy from flowing water", "", machine(MachineTier.MEDIUM, GENERATOR), powerBuffer(128), LoreBuilderDynamic.powerPerSecond(16));
    public static final SlimefunItemStack WATER_TURBINE = new SlimefunItemStack("WATER_TURBINE", PRISMARINE_WALL, "&6Hydro Turbine", "", "&fCreates energy from flowing water", "", machine(MachineTier.MEDIUM, GENERATOR), powerBuffer(512), LoreBuilderDynamic.powerPerSecond(64));
    public static final SlimefunItemStack DRAGON_GENERATOR = new SlimefunItemStack("DRAGON_GENERATOR", GRAY_CONCRETE, "&6Dragon Egg Generator", "", "&fCreates energy from the warmth of a Dragon Egg", "", machine(MachineTier.MEDIUM, GENERATOR), powerBuffer(512), LoreBuilderDynamic.powerPerSecond(32));
    public static final SlimefunItemStack CHIPPING_GENERATOR = new SlimefunItemStack("CHIPPING_GENERATOR", SPRUCE_WOOD, "&6Chipping Generator", "", "&fCreates energy from broken items", "&f(Durability based items)", "", machine(MachineTier.MEDIUM, GENERATOR), powerBuffer(256), LoreBuilderDynamic.power(8, " per durability point"));
    public static final SlimefunItemStack CULINARY_GENERATOR = new SlimefunItemStack("CULINARY_GENERATOR", BLAST_FURNACE, "&6Culinary Generator", "", "&fCreates energy from food energy", "", machine(MachineTier.MEDIUM, GENERATOR), powerBuffer(256), LoreBuilderDynamic.powerPerSecond(8));
    public static final SlimefunItemStack STARDUST_REACTOR = new SlimefunItemStack("STARDUST_REACTOR", IRON_BLOCK, "&6Stardust Reactor", "", "&6Uses Star Dust to produce larges amount of power.", "", machine(MachineTier.END_GAME, GENERATOR), powerBuffer(32768), LoreBuilderDynamic.powerPerSecond(1024));
