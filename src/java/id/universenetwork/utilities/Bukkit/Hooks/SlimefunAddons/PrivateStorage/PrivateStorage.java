...
public class PrivateStorage extends id.universenetwork.utilities.Bukkit.Hooks.SlimefunAddons.SFInstance {
    @Override
    public void Load() {
        ...
        new id.universenetwork.utilities.Bukkit.Hooks.SlimefunAddons.PrivateStorage.Storage.PublicChests(this, itemGroup);
        new id.universenetwork.utilities.Bukkit.Hooks.SlimefunAddons.PrivateStorage.Storage.PrivateChests(this, itemGroup);
    }
}