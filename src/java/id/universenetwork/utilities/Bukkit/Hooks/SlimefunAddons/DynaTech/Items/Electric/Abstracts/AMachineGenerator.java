...
public abstract class AMachineGenerator extends SlimefunItem implements RecipeDisplayItem, EnergyNetProvider {
    ...
    @Override
    public int getGeneratedOutput(Location l, @NotNull Config data) {
    ...
    boolean isBucket(@Nullable ItemStack item) {
        if (item == null) return false;
        ItemStackWrapper wrapper = ItemStackWrapper.wrap(item);
        return item.getType() == Material.LAVA_BUCKET || isItemSimilar(wrapper, SlimefunItems.FUEL_BUCKET, true) || isItemSimilar(wrapper, SlimefunItems.OIL_BUCKET, true);
    }
    ...
    public void registerFuel(@NotNull MachineFuel fuel) {
