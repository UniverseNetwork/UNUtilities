...
public class ExtraHeads extends id.universenetwork.utilities.Bukkit.Hooks.SlimefunAddons.SFInstance {
    ...
    void registerHead(String name, EntityType type, String texture) {
        try {
            double chance = id.universenetwork.utilities.Bukkit.Manager.Config.config.getOrSetDefault(configPath + "chances." + type.toString(), 5.0);
