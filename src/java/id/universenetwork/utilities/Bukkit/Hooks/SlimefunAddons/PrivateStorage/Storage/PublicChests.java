...
public class PublicChests {
    public PublicChests(id.universenetwork.utilities.Bukkit.Hooks.SlimefunAddons.PrivateStorage.PrivateStorage addon, io.github.thebusybiscuit.slimefun4.api.items.ItemGroup itemGroup) {
