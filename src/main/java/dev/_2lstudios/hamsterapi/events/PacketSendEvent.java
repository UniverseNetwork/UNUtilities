...
public class PacketSendEvent extends PacketEvent {
    ...
    public PacketSendEvent(final ChannelHandlerContext channelHandlerContext, final HamsterPlayer hamsterPlayer, final PacketWrapper packet, final boolean async) {
