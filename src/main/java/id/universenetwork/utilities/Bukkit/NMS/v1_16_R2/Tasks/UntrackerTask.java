...
import static net.minecraft.server.v1_16_R2.MinecraftServer.getServer;
...
public class UntrackerTask extends BukkitRunnable {
    ...
    void untrackProcess(String worldName) {
        ...
        for (int id : toRemove) {
            ...
            if (ETFBoolean(DISABLETICKUNTRACKED)) getInstance().disableTicking(ws.entitiesById.get(id));
        }
        if (ETFBoolean(LOG))
