...
public class Scythe extends SimpleSlimefunItem<ItemUseHandler> implements NotPlaceable {
    ...
    public ToolUseHandler onBlockBreak() {
        return (e, tool, fortune, drops) -> {
            ...
            if (e.getBlock().getBlockData() instanceof Ageable && ((Ageable) e.getBlock().getBlockData()).getAge() == ((Ageable) e.getBlock().getBlockData()).getMaximumAge()) {
