...
public class ExtraHeads {
    ...
    public ExtraHeads() {
        if (Enabled("ExtraHeads")) {
            ...
            if (getMinecraftVersion().isAtLeast(MinecraftVersion.MINECRAFT_1_14)) {
            ...
            if (getMinecraftVersion().isAtLeast(MinecraftVersion.MINECRAFT_1_15))
                registerHead("Bee Head", EntityType.BEE, "4420c9c43e095880dcd2e281c81f47b163b478f58a584bb61f93e6e10a155f31");
            if (getMinecraftVersion().isBefore(MinecraftVersion.MINECRAFT_1_16))
                ...
                registerHead("Strider Head", EntityType.STRIDER, "18a9adf780ec7dd4625c9c0779052e6a15a451866623511e4c82e9655714b3c1");
            ...
            if (getMinecraftVersion().isAtLeast(MinecraftVersion.MINECRAFT_1_17)) {
                registerHead("Axolotl Head", EntityType.valueOf("AXOLOTL"), "5c138f401c67fc2e1e387d9c90a9691772ee486e8ddbf2ed375fc8348746f936");
                registerHead("Glow Squid Head", EntityType.valueOf("GLOW_SQUID"), "3e94a1bb1cb00aaa153a74daf4b0eea20b8974522fe9901eb55aef478ebeff0d");
                registerHead("Goat Head", EntityType.valueOf("GOAT"), "457a0d538fa08a7affe312903468861720f9fa34e86d44b89dcec5639265f03");
            }
            new HeadListener(this);
            System.out.println(prefix + " §bSuccessfully Registered §dExtraHeads §bAddon");
        }
    }

    void registerHead(String name, EntityType type, String texture) {
        try {
            double chance = get().getDouble(ADDONSSETTINGS.getConfigPath() + "ExtraHeads.Chances." + type.toString(), 5.0);
