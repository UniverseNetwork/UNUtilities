...
public enum ChatUtil {
    ...
    final SkriptColor skriptColor;
    final ChatColor bungeeChatColor;
    ...
    public static SkriptColor getSkriptColorByBungee(ChatColor chatColor) {
        for (ChatUtil value : ChatUtil.values()) if (chatColor == value.bungeeChatColor) return value.skriptColor;
        return null;
    }
