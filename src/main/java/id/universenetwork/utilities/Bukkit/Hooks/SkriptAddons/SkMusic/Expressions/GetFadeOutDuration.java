...
public class GetFadeOutDuration extends ch.njol.skript.lang.util.SimpleExpression<Integer> {
    ...
    public String toString(@Nullable Event e, boolean paramBoolean) {
        return "[skmusic|nbs] fade out duration of [player] %player%";
    }
    ...
    protected Integer[] get(Event e) {
        ...
        int duration = 0;
        if (songPlayers.containsKey(p)) duration = songPlayers.get(p).getFadeOut().getFadeDuration();
