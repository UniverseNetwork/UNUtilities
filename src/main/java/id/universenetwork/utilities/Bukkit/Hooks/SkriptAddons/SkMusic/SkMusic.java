...
import id.universenetwork.utilities.Bukkit.Hooks.SkriptAddons.SkMusic.Conditions.SongExist;
...
public class SkMusic {
    ...
    public SkMusic() {
        ...
        registerCondition(SongExist.class, "[skmusic] [nbs] (song|music) %string% exist");
