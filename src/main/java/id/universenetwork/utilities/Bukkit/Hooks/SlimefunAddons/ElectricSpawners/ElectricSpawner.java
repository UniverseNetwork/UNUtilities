...
public class ElectricSpawner extends SimpleSlimefunItem<BlockTicker> implements EnergyNetComponent {
    static final int ENERGY_CONSUMPTION = 240;
    static int lifetime = 0;
    final EntityType entity;

    public ElectricSpawner(ItemGroup itemGroup, String mob, EntityType type, Research research, boolean SilkSpawnersSupport) {
        // @formatter:off
        super(itemGroup, new SlimefunItemStack("ELECTRIC_SPAWNER_" + mob, "db6bd9727abb55d5415265789d4f2984781a343c68dcaf57f554a5e9aa1cd", "&ePowered Spawner &7(" + humanize(mob) + ")", "", "&8\u21E8 &e\u26A1 &7Max Entity Cap: 6", "&8\u21E8 &e\u26A1 &7512 J Buffer", "&8\u21E8 &e\u26A1 &7240 J/Mob"), RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[]{null, PLUTONIUM, null, ELECTRIC_MOTOR, ElectricSilkSpawner.get(type, SilkSpawnersSupport), ELECTRIC_MOTOR, BLISTERING_INGOT_3, LARGE_CAPACITOR, BLISTERING_INGOT_3});
        // @formatter:on
        this.entity = type;
