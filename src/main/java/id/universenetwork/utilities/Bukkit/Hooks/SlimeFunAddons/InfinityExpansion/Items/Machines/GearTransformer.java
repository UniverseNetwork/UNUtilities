...
import id.universenetwork.utilities.Bukkit.Hooks.SlimeFunAddons.InfinityExpansion.Items.Abstracts.AbstractEnergyCrafter;
...
import static id.universenetwork.utilities.Bukkit.Libraries.InfinityLib.Machines.MenuBlock.NO_ROOM_ITEM;

@ParametersAreNonnullByDefault
public final class GearTransformer extends AbstractEnergyCrafter implements RecipeDisplayItem {
    static final boolean SF = getConfig().getBoolean("balance-options.allow-sf-item-transform");
    static final int[] OUTPUT_SLOTS = {40};
    static final int[] INPUT_SLOTS = {10, 16};
    static final int STATUS_SLOT = 13;
    static final ItemStack[] TOOL_RECIPE = {new ItemStack(Material.OAK_PLANKS, 4), new ItemStack(Material.COBBLESTONE, 4), new ItemStack(Material.IRON_INGOT, 4), new ItemStack(Material.GOLD_INGOT, 4), new ItemStack(Material.DIAMOND, 4), new ItemStack(Material.NETHERITE_INGOT, 2)};
    static final ItemStack[] ARMOR_RECIPE = {new ItemStack(Material.LEATHER, 9), new ItemStack(Material.CHAIN, 9), new ItemStack(Material.IRON_INGOT, 9), new ItemStack(Material.GOLD_INGOT, 9), new ItemStack(Material.DIAMOND, 9), new ItemStack(Material.NETHERITE_INGOT, 2)};
    static final String[] ARMOR_TYPES = {"_HELMET", "_CHESTPLATE", "_LEGGINGS", "_BOOTS"};
    static final String[] TOOL_TYPES = {"_SWORD", "_PICKAXE", "_AXE", "_SHOVEL", "_HOE"};
    static final String[] TOOL_MATERIALS = {"WOODEN", "STONE", "IRON", "GOLDEN", "DIAMOND", "NETHERITE"};
    static final String[] ARMOR_MATERIALS = {"LEATHER", "CHAINMAIL", "IRON", "GOLDEN", "DIAMOND", "NETHERITE"};
    ...
    protected void setup(@Nonnull BlockMenuPreset blockMenuPreset) {
        ...
        blockMenuPreset.drawBackground(new CustomItemStack(Material.BLUE_STAINED_GLASS_PANE, "&9Tool Input"), new int[]{0, 1, 2, 9, 11, 18, 19, 20});
        blockMenuPreset.drawBackground(new CustomItemStack(Material.BLUE_STAINED_GLASS_PANE, "&9Material Input"), new int[]{6, 7, 8, 15, 17, 24, 25, 26});
    }
    ...
    @Nullable
    static Pair<Material, Integer> getOutput(ItemStack inputMaterial, String inputToolType) {
    ...
    @Nullable
    static String getType(ItemStack item) {
