...
public class ReflectionAPI {
    ...
    static boolean staticFinalModificationBlocked;
    ...
    public static Field getField(Class clazz, String fieldname) {
        ...
        Field field = null;
        if (fields.containsKey(key)) field = fields.get(key);
        else {
            try {
    ...
    public static void setFieldNotFinal(Field field) {
        ...
        if (staticFinalModificationBlocked) try {
        ...
        else setValuePrintException(Field.class, field, "modifiers", modifiers & ~Modifier.FINAL);
    }
    ...
    public static void setValue(Class clazz, String fieldname, Object value) throws IllegalAccessException {
    ...
    public static void setFinalValue(Class clazz, Object object, String fieldname, Object value) throws IllegalAccessException {
        setValue(clazz, object, fieldname, value, true);
    }

    public static void setFinalValue(Object object, String fieldname, Object value) throws IllegalAccessException {
        setValue(object.getClass(), object, fieldname, value, true);
    }

    public static void setFinalValue(Class clazz, String fieldname, Object value) throws IllegalAccessException {
