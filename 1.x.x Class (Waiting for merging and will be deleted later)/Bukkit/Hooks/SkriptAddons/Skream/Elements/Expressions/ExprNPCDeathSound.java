...
public class ExprNPCDeathSound extends ch.njol.skript.lang.util.SimpleExpression<String> {
    static {
        ch.njol.skript.Skript.registerExpression(ExprNPCDeathSound.class, String.class, ch.njol.skript.lang.ExpressionType.COMBINED, "deathsound of npc [with] [the] [id] %integers%");
    }
